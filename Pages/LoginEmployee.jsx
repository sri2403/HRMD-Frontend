...
const LoginEmployee = () => {
    const {email,setEmail,password,setPassword,loginEmployee} = useContext(AuthContext);
            ...
            <div className="card">
                <div className="card-body p-4">
                    <h2 className="card-title text-center p-2">
                        <strong><i className="fa-solid fa-user"></i> Login as Employee</strong>
                    </h2>
                    <form className='p-2' onSubmit={handleSubmit}>
                        ...
                        <div className='text-center mt-2'>
                            <p><Link to="/employee-forgot-password" className='text-decoration-none'>Forgot Password?</Link></p>
                            <button type='submit' className="btn btn-success btn-block">Sign In</button>
                        </div>
                        <p className="mt-3 text-center">Don't have an account? <Link to="/register/employee" className='text-decoration-none'>Create Account</Link></p>
                    </form>
