        ...
        <div className="container mt-4">
            <div className="card">
                <div className="card-body">
                    <h3 className="card-title">Update Candidate</h3>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <label htmlFor="domain" className="form-label">Experience</label>
                                <input type="text" className="form-control" id="domain" value={experience} onChange={(e) => setExperience(e.target.value)} required />
                            </div>
                            <div className="col-md-6">
