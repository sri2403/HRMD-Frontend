...
const CreateEmployee = ({adminId}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://hrmd-backend.onrender.com/api/createEmployee", payload);
                ...
                <div className="col-md-8">
                    <div className="card">
                        <h2 className="card-title text-center p-2">
                            <strong><i className="fa-solid fa-user"></i> Create Employee</strong>
                        </h2>
